...
COS_API_KEY_ID="NIWLKlrbrO-jWEXTiL91sN6jNldT7zlJHqKFW82gulWN"
COS_INSTANCE_CRN="crn:v1:bluemix:public:cloud-object-storage:global:a/347dc234e4e148f49608ec253ff3a652:15f24054-fbe4-4849-81ee-e4c8cfaa4ba5::"
...
@app.route('/')
def index():
    files = get_bucket_contents('rathi')
